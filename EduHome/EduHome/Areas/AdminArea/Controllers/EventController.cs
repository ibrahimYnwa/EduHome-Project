...
namespace EduHome.Areas.AdminArea.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public async Task<IActionResult> CreateEvent()
        {
            ...
            eventVM.Categories = new List<CategoryVM>();
            eventVM.Speakers = new List<SpeakerVM>();
            ...
            {
                eventVM.Categories.Add(new CategoryVM { Name = category.Name });
            }

            foreach (var speaker in Speakers)
            {
                eventVM.Speakers.Add(new SpeakerVM { Name = speaker.Name });
            }
